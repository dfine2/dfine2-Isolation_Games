...
'LIGHTER', 'PHONE', 'RINGTONE', 'MUSIC', 'COMPUTER', 'SMOG', 'CZAR', 'SPLATTER','COVID 19', 'FEVER', 'COUGH', 'GLOVE', 'TEMPERATURE', 'VENTILATOR', 'ISOLATION','QUARANTINE',
...
'DOPE','INDIANA','IDIOT','ROUNDABOUT','TINCTURE','PERMIT','PACT','ANEMONE','YO-YO','SCRAPE','ADORNMENT','QUILT','YOGA','CLASP','ABACUS','MISDEMEANOR','SHALE',
...
'GODZILLA','CHEWBACCA','ARTICHOKE',,'EMPEROR','TURKMENISTAN','PUFFERFISH','AEROSOL','LEOPARD','GOLLUM','EARPLUG','ACCIDENT','DJ','SHAKIRA','TOILET','EFFORT','APPARITION','MEASLES','TAPIR',
