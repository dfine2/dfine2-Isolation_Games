...
const veda = ['QUESADILLA', "ALBUQUERQUE", "SASQUATCH", "SILICON VALLEY", "NUCLEUS", "ALCHEMY", "APP", "SCIENCE", "SPACE", "RETRO", "MONITOR", "HOME", "PORTAL", "CIRCLE", "PARROT", "MARIO",
    "LUIGI", "REVIEW", "SPOTIFY", "SNACK", "LEARNING", "RICE", "BEANS", "MACHINE", "GOBLIN", 'CANADA', 'VEGETARIAN', 'SOAP', 'TOBACCO', 'SCANDAL', 'NORMAL', 'AARDVARK',
    'MAP', 'CAPTAIN', 'SWARM', 'GUILT', 'IGLOO', 'CABINET', 'JERK', 'WAGON', 'SURF', 'TIDE', 'CROWBAR', 'BATMAN', 'LEX LUTHOR', 'LOOFAH', 'TEMPER', 'FIT', 'POLITICS', 'JAZZ', 'FORCE', 'CROISSANT', 'DICTIONARY',
    'PEOPLE', 'CHILD', 'OKRA', 'WORLD', 'FAMILY', 'PROBLEM', 'CASE', 'CAT', 'BAT', 'BALL', 'HAT', 'HEAD', 'POTATO', 'FUR', 'GERM', 'CANDLE', 'SCENT', 'BANANA', 'GEISER', 'WATER', 'LAKE', 'POND', 'OCEAN', 'CARPET', 'RUG', 'MAT',
    ...
    'BURP', 'METAPHOR', 'GORGE', 'WIMBLEDON', 'ALCATRAZ', 'LADDER', 'HIERARCHY', 'INCIDENT', 'HACKYSACK', 'ANTAGONIST', 'WOE', 'SANDBAG', 'MULLET', 'CORKSCREW', 'BLADDER', 'BLOOD', 'ZERO', 'SILENCE', 'DUST',
    , 'LIZARD', 'STORM', 'STRANGER', 'DANGER', 'CLONE', 'ATHENA', 'ETIQUETTE', 'CLAIRVOYANT', 'TRUFFLE', 'PEASANT', 'TORRENT', 'CLEMENTINE', 'SUSPENDERS', 'MILESTONE', 'RUMBLE', 'SCHEME', 'LORAX',
    'TICKLE', 'BALLOON', 'FATIGUE', 'VORTEX', 'RIBBIT', 'ELMO', 'WINERY', 'CLAN', 'DEODORANT', 'CHAPSTICK', 'PLOUGH', 'TRICK', 'CATAPULT', 'GLITTER', 'PHAROAH', 'INDIGO', 'QUIP', 'LIAR', 'CRAWDAD', 'EMT', 'GRUDGE', 'CASABLANCA',
    'DOPE', 'INDIANA', 'IDIOT', 'ROUNDABOUT', 'POTION', 'PERMIT', 'PACT', 'ANEMONE', 'YO-YO', 'SCRAPE', 'ORNAMENT', 'QUILT', 'YOGA', 'CLASP', 'ABACUS', 'MISDEMEANOR',
    'CORAL', 'DELTA', 'INSULT', 'ROADBLOCK', 'FLUKE', 'DAWN', 'XEROX', 'ALBACORE', 'HALIFAX', 'TOPOGRAPHY', 'STERNUM', 'FLOP', 'ANAGRAM', 'CONDO', 'POPSICLE', 'SLANDER', 'J LO', 'CYPRUS', 'ORB',
    'LISTERINE', 'ALPACA', 'MUSHROOM', 'MAVERICK', 'QUOTE', 'BLANKET', 'RAGE', 'PISTON', 'GENUS', 'CEMENT', 'ALLIGATOR', 'CANVAS', 'DINGO', 'DETAIL', 'COUNCIL', 'MUMBLE', 'STAPHYLOCOCCUS', 'TUPAC',
    ...
    'IGUANA', 'DRUNKARD', 'BAGPIPES', 'GIRDLE', 'ARMOR', 'SOUTHWEST', 'LINT', 'LINGUINI', 'BAR MITZVAH', 'CHASE', 'PROPOSAL', 'PURPOSE', 'FURBY', 'SIREN', 'EVIL', 'LATTE', 'MOOD', 'CHARACTER', 'HYDROGEN', 'CANTELOUPE', 'NAPKIN',
    'MAHJONG']
