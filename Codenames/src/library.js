...
'LISTERINE','ALPACA','MUSHROOM','MAVERICK', 'QUOTE', 'COMFORT','RAGE','PISTON','GENUS','CEMENT','ALLIGATOR','CANVAS','ANXIETY','ACCEPTANCE','DINGO','DETAIL','COUNCIL']

const uniques = new Set([...standard, ...veda])

console.log(uniques)

const library = [...uniques]
